...
# Display style options with radio buttons
style_names = [style["name"] for style in video_styles]
style_selected_name = st.radio("Select your video style", style_names)
style_selected = next(style for style in video_styles if style["name"] == style_selected_name)

# Display selected style description and preview
...
# Process the audio and image to create the video
